    ...
    <div class="border border-gray-200 rounded-lg overflow-hidden flex flex-grow">
      ...
      <div class="flex-1 grid grid-cols-5">
        ...
        <div
          v-for="i in 5"
          :key="`slot-1-${i}`"
          class="h-20 border-b border-gray-200 border-r border-gray-200 p-1"
        ></div>
        ...
        <div
          v-for="i in 5"
          :key="`slot-4-${i}`"
          class="h-20 border-b border-gray-200 border-r border-gray-200 p-1 last:border-r-0"
        ></div>
        ...
        <div
          v-for="i in 5"
          :key="`slot-7-${i}`"
          class="h-20 border-r border-gray-200 p-1 last:border-r-0"
        ></div>
      </div>
    </div>
  </div>
