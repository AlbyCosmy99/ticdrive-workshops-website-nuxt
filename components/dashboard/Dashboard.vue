    ...
    <div class="flex flex-col p-6 w-full">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center mb-4">
          ...
          <button class="flex items-center text-white bg-[#39b269] px-4 py-2 rounded-md">
            Vedi tutto
          ...
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Voto</th>
              </tr>
            </thead>
