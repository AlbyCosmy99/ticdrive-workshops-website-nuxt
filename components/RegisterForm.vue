<template>
  <div class="px-3 w-full">
    ...
    >
      <h1 class="text-4xl text-zinc-600 text-center font-semibold">
        Benvenuto!
      </h1>
      ...
      <FormInput
        ...
        type="tel"
        :error-message="
          v0$.tel.$errors.length ? v0$.tel.$errors[0].$message : ''
        "
      />
      <FormInput
        id="email"
      ...
      <FormInput
        ...
        v-model="postalCode"
        :error-message="
          v0$.postalCode.$errors.length
            ? v0$.postalCode.$errors[0].$message
            : ''
        "
      />
      <div class="flex gap-1 mt-4 items-center">
        <div
          :class="[
            ...
            accept1 ? 'border-green-600' : 'border-gray-600',
          ]"
          @click="checkToggle(1)"
        >
      ...
      <div class="flex gap-1 mt-2 items-center">
        <div
          :class="[
            'w-4 h-4 border rounded',
            accept2 ? 'border-green-600' : 'border-gray-600',
          ]"
          @click="checkToggle(2)"
        >
    ...
    >
      ...
      <div class="flex flex-col mt-10">
        ...
        <FormInput
          ...
          size="small"
        />
        <FormInput placeholder="CAP:" v-model="fullAddress.add4" size="small" />
      </div>
      <div class="mt-4">
    ...
    <div
      v-if="currentStep === 3"
      class="step-3 flex flex-col w-full mx-auto max-w-lg max-md:mt-10 max-md:max-w-full justify-center"
    >
      <h1 class="text-4xl text-gray-500 font-semibold">
    ...
    >
      ...
      <div v-if="!currentStep" class="flex text-center mt-3 justify-center">
...
const checkToggle = (check: number) => {
  if (check === 1) accept1.value = !accept1.value;
  else if (check === 2) accept2.value = !accept2.value;
};
...
// WATCH
watch([accept1, accept2, currentStep], ([newAccept1, newAccept2]) => {
  buttonDisable.value = !(newAccept1 && newAccept2);
});
</script>
