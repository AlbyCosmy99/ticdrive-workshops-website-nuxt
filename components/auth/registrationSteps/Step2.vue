  ...
  >
    ...
    <div class="flex flex-col mt-10">
      ...
      <FormInput
        ...
        size="small"
        :error-message="
          v$.fullAddress.add1.$errors.length
            ? v$.fullAddress.add1.$errors[0].$message
            : ''
        "
      />
      <FormInput
        ...
        size="small"
        :error-message="
          v$.fullAddress.add2.$errors.length
            ? v$.fullAddress.add2.$errors[0].$message
            : ''
        "
      />
      <FormInput
        ...
        size="small"
        :error-message="
          v$.fullAddress.add3.$errors.length
            ? v$.fullAddress.add3.$errors[0].$message
            : ''
        "
      />
      <FormInput
        ...
        size="small"
        :error-message="
          v$.fullAddress.add4.$errors.length
            ? v$.fullAddress.add4.$errors[0].$message
            : ''
        "
      />
    </div>
