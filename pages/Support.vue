<template>
  <div class="min-h-screen bg-gray-50 p-6">
    ...
    <div
      class="max-w-4xl mx-auto bg-white rounded-md shadow-sm border-2 border-green-500"
    >
      <div class="p-6">
        <!-- Search Section -->
        <div class="mb-8">
            ...
            >
              <div class="flex justify-between items-center">
                ...
                <svg
                  ...
                  :class="
                    faq.isOpen ? 'text-green-500 rotate-45' : 'text-gray-500'
                  "
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <div
                v-if="faq.isOpen"
                class="mt-4 text-gray-600 transition-all duration-200 ease-in-out"
              >
                {{ faq.answer }}
              </div>
            </div>
    ...
    const faqs = ref([
      {
        ...
        answer:
          "Apri l'app o il sito di TicDrive, inserisci i dettagli del veicolo e la posizione, quindi seleziona il tipo di servizio e l'orario. La prenotazione è semplice e veloce.",
        isOpen: false,
      },
      {
        question: 'Come posso aggiungere o aggiornare un metodo di pagamento?',
        answer:
          'Vai al tuo profilo e tocca "Metodi di pagamento" per aggiungere o aggiornare l\'opzione preferita.',
        isOpen: false,
      },
      {
        question: 'Posso prenotare un servizio durante il fine settimana?',
        answer:
          'Si, puoi programmare servizi qualsiasi giorno della settimana, compresi i fine settimana.',
        isOpen: false,
      },
      {
        question: 'Posso cancellare o modificare una prenotazione?',
        answer:
          "Si, le prenotazioni possono essere cancellate o modificate almeno 24 ore prima dell'orario previsto.",
        isOpen: false,
      },
    ]);
