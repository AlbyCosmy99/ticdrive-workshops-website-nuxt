<template>
  <div class="prose max-w-none text-sm">
    ...
    <h2 class="text-lg font-semibold mb-3 mt-8">
...
const privacyPolicySections = [
  ...
  },
  {
    ...
    content:
      'We will only use your Personal Data in accordance with Italy\'s Data Protection Code Legislative Decree no. 101 ("DPC"), the EU\'s General Data Protection Regulation ("GDPR"), and, of course, only as described in this Privacy Policy.',
  },
  {
  ...
  },
  {
    ...
    content: `<p>We may collect and process the following Personal Data about you:</p>
